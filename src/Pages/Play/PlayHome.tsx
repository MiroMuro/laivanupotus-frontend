...
const PlayHome = () => {
  ...
  return (
    <div className="h-1/3 w-1/4 flex flex-col bg-battleship-blue-light rounded-md border-gray-400 border-4  text-white">
      <h1 className="text-4xl text-white w-full text-center">
        Play battleships!
      </h1>
      <div className="flex flex-row justify-evenly align-middle w-full h-full px-2">
        <div className="flex-1 flex flex-col h-2/6  bg-battleship-blue-light justify-end my-auto border-2 rounded-xl mx-2  border-gray-400  shadow-xl transition transformation ease-in-out 200ms active:scale-75 hover:scale-105">
          <button
